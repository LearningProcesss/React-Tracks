  ...
  return (
    <div className={classes.root}>
            ...
            (createUser, { loading, error }) => {
              return (
                <form onSubmit={event => handleSubmit(event, createUser)} className={classes.form}>
                  ...
                  <Button type="submit" classes={classes.submit} disabled={loading || !username.trim() || !email.trim() || !password.trim()} fullWidth variant="contained" color="secondary">{loading ? "Registering.." : "Register"}</Button>
                  <Button onClick={() => setNewUser(false)} type="submit" fullWidth variant="contained" color="secondary">Sign in</Button>
      ...
      <Dialog disableBackdropClick={true} open={open} TransitionComponent={Transition}>
        <DialogTitle>
          <VerifiedUserTwoTone className={classes.icon}></VerifiedUserTwoTone>
          New account
          </DialogTitle>
        <DialogContent>
          <DialogContentText>User {username} succesfully created!</DialogContentText>
        </DialogContent>
        <DialogActions>
